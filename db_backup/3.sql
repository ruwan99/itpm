...
INSERT INTO `not_available_times_rooms` (`id`,`room_name`,`day`,`start_time`,`end_time`,`detail`) VALUES 
 (4,'Ruwan Building','Tuesday','08:00','10:00',''),
 (5,'room 123','Saturday','09:00','10:00','');
...
INSERT INTO `rooms` (`room_id`,`room_type`,`room_capacity`,`room_related_building_name`,`room_name`) VALUES 
 ...
 (7,'Lecture Hall',150,'Building 2','Ruwan Building');
