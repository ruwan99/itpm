 ...
 * @author Anjula
 */
public class mt_add_view_tags extends javax.swing.JFrame {
     ...
     */
    public mt_add_view_tags() throws SQLException {
        initComponents();
        loadDataToTable();
    }
    ...
    private void addTag() {
        ...
        try {
            ...
            Logger.getLogger(mt_add_view_tags.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mt_add_view_tags.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
