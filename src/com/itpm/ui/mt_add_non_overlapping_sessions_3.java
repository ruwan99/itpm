 ...
 * @author
 */
public class mt_add_non_overlapping_sessions_3 extends javax.swing.JFrame {
     ...
     * Creates new form A
     */
    public mt_add_non_overlapping_sessions_3() {
        initComponents();
        loadDataToTable();
    ...
    private void loaddataToSessionsComboBox() {
        try {
            ...
            Logger.getLogger(mt_add_non_overlapping_sessions_3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void loadDataToTable() {
         ...
         */
        try {
            ResultSet rset = new SessionsDaoImpl().getSessionBySessionType(CommonConstants.NON_OVERLAPPING);
        ...
        if (id != 0) {
            try {
                SessionManagementController.updateSession(id, comboSessions.getSelectedItem().toString(), "",
                        ...
                        CommonConstants.NON_OVERLAPPING, "", comboSessions1.getSelectedItem().toString());
            } catch (SQLException ex) {
                Logger.getLogger(mt_add_non_overlapping_sessions_3.class.getName()).log(Level.SEVERE, null, ex);
            }
            id = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mt_add_non_overlapping_sessions_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
