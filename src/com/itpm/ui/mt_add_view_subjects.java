 ...
 * @author Anjula
 */
public class mt_add_view_subjects extends javax.swing.JFrame {
    ...
    private void addSubject() {
        try {
            ...
            Logger.getLogger(mt_add_view_subjects.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mt_add_view_subjects.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
